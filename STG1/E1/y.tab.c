...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 20 "intopf.y" /* yacc.c:1646  */
    {
				(yyval.no) = (yyvsp[0].no);
        printf("Postfix\n");
				evaluate_post((yyvsp[-1].no));
        printf("\nPrefix\n");
        evaluate_pre((yyvsp[-1].no));
				exit(1);
			}
